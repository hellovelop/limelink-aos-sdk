...
```
- Please refer to [*here]([https://jitpack.io/#hellovelope/limelink-aos-sdk/1.0.0-1-gf3b1b3e-SNAPSHOT](https://jitpack.io/#hellovelope/limelink-aos-sdk/0.0.3)) for **maven**, **sbt**, or **leiningen**.
